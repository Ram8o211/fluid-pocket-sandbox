...
export class ParticleSystem {
  constructor(capacity=1800){
    ...
    this.meltingTemperature=new Float32Array(capacity);this.boilingTemperature=new Float32Array(capacity);this.phaseHysteresis=new Float32Array(capacity);this.volatility=new Float32Array(capacity);this.reactionPotential=new Float32Array(capacity);this.compressibility=new Float32Array(capacity);
    this.materialId=new Int32Array(capacity);this.phase=new Int32Array(capacity);this.cell=new Int32Array(capacity);
  }
  add(p,material,phase=Number(Phase.LIQUID)){
    ...
    this.materialId[i]=material.id; this.temperature[i]=p.temperature??material.temperature; this.phase[i]=phase; this.phaseProgress[i]=0;
