...
export const MATERIAL_RANGES = Object.freeze({
  ...
  temperature: [0, 1], heatCapacity: [0.15, 1], thermalConductivity: [0.02, 1],
  meltingTemperature: [0.05, 0.6], boilingTemperature: [0.45, 0.95],
  phaseTransitionHysteresis: [0.005, 0.08], volatility: [0, 1], reactionPotential: [-1, 1],
  compressibility: [0.1, 1], opacity: [0.08, 1]
});
...
export function materialVector(m) {
  ...
  return [
    (m.density-0.35)/1.3, m.viscosity, m.cohesion, m.miscibility, m.temperature,
    m.heatCapacity, m.thermalConductivity, m.meltingTemperature, m.boilingTemperature,
    m.volatility, (m.reactionPotential+1)/2, m.opacity, r,g,b
  ];
}
...
export function weightedMaterialMean(a, b, massA, massB, id) {
  ...
  return sanitizeMaterial({
    ...
    cohesion: mean('cohesion'), miscibility: mean('miscibility'), temperature: mean('temperature'),
    ...
    reactionPotential: mean('reactionPotential'), compressibility: mean('compressibility')
  });
}
