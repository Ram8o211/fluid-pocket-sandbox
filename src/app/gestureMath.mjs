...
export function clampCameraDistance(value,min=6,max=22){return Math.max(min,Math.min(max,value));}
export function pinchCameraDistance(startDistance,startPinch,currentPinch,min=6,max=22){
