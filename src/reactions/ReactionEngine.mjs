...
export class ReactionEngine {
  ...
  step(ps,grid,rules,dt){
    ...
    for(let i=0;i<ps.count;i++) grid.forEachNeighbor(ps,i,radius,(j)=>{
      ...
      const propD=this.particleDistance(ps,i,j),visual=saturate(compat*propD*contact*rules.reactionStrength),t=clamp(rate*dt,0,.22);this.mixPair(ps,i,j,t,rules);
